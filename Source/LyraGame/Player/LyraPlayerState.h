...
public:
	...
	/*
	* Start @CruorRTS_CodeModification function to listen to Experience ready for using default pawn data in the loaded Experience.
	* This is useful for the CruorRTSUnitLeaderSpawner ActorComponent.
	* @CruorRTS_CodeAttribution This section is taken in whole or part from NanceDevDiaries see: https://www.github.com/NanceDevDiaries/
	*/
...
private:
	...
	/*
	* Start @CruorRTS_CodeModification keep track to make sure the PawnData isn't set more than once while the PlayerState exists.
	* This is needed since we're no longer calling that logic in PostInitializeComponents(); which only happened once per PlayerState
	* @CruorRTS_CodeAttribution This section is taken in whole or part from NanceDevDiaries see: https://www.github.com/NanceDevDiaries/
	*/
