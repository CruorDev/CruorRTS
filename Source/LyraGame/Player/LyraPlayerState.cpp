...
/* Start @CruorRTS_CodeModification delay OnExperienceLoaded to wait until the pawn is set, and so is their pawn data in their Pawn Extension Component for pawns that don't want to use the Pawn Data from the experience component. 
