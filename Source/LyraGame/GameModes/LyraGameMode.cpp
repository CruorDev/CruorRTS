...
{
	/* Start @CruorRTS_CodeModification use the pawn data info if that's been setup. Useful for not using the experience default pawn data and/or when there's no PlayerState. 
