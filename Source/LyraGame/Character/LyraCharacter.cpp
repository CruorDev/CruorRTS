...
void ALyraCharacter::PossessedBy(AController* NewController)
{
	...
	/*
	* Start @CruorRTS_CodeModification replacement for ALyraPlayerState::PostInitializeComponents() binding to OnExperience ready.
	* This is used by the CruorRTSUnitLeaderSpawner ActorComponent.
